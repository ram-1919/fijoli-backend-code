...
const { post } = require('./index.js');
    ...
    async function insertpostfileInfo(postinfo, post_category_id, currency_category_id){
        ...
        postinfo.post_pic_1_path = (postinfo.post_pic_1_path)?postinfo.post_pic_1_path:"";
        postinfo.post_pic_2_path = (postinfo.post_pic_2_path)?postinfo.post_pic_2_path:"";
        postinfo.post_video_1_path = (postinfo.post_video_1_path)?postinfo.post_video_1_path:"";
    ...
    module.exports = {getsysconfiguration,insertuploadfileInfo, 
        ...
        deleteuserreview, 
        deletepostitem, updatepostfileinfo} 
